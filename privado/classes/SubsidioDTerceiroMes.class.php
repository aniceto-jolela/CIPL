 ...
 * @package entity
 */
class SubsidioDTerceiroMes extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='SubsidioDTerceiroMes';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='subsidio_d_terceiro_mes';
	const SQL_INSERT='INSERT INTO `subsidio_d_terceiro_mes` (`id`,`funcionario_id`,`subsidio`,`n_beneficiario`,`data_emissao`) VALUES (?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `subsidio_d_terceiro_mes` (`funcionario_id`,`subsidio`,`n_beneficiario`,`data_emissao`) VALUES (?,?,?,?)';
	const SQL_UPDATE='UPDATE `subsidio_d_terceiro_mes` SET `id`=?,`funcionario_id`=?,`subsidio`=?,`n_beneficiario`=?,`data_emissao`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `subsidio_d_terceiro_mes` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `subsidio_d_terceiro_mes` WHERE `id`=?';
	const FIELD_ID=-491740316;
	const FIELD_FUNCIONARIO_ID=-114281784;
	const FIELD_SUBSIDIO=-1607470147;
	const FIELD_N_BENEFICIARIO=-1617026764;
	const FIELD_DATA_EMISSAO=860397123;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of SubsidioDTerceiroMes instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param SubsidioDTerceiroMes $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return SubsidioDTerceiroMes[]
	 */
	public static function findByExample(PDO $db,SubsidioDTerceiroMes $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of SubsidioDTerceiroMes instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `subsidio_d_terceiro_mes`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of SubsidioDTerceiroMes instances
	 *
	...
	/**
	 * returns the result as an array of SubsidioDTerceiroMes instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return SubsidioDTerceiroMes[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of SubsidioDTerceiroMes instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `subsidio_d_terceiro_mes`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'SubsidioDTerceiroMes');
	}

	/**
	 * get single SubsidioDTerceiroMes instance from a DOMElement
	 *
	...
	/**
	 * get all instances of SubsidioDTerceiroMes from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('SubsidioDTerceiroMes') as $node) {
