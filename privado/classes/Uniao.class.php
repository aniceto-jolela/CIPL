 ...
 * @package entity
 */
class Uniao extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='Uniao';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='uniao';
	const SQL_INSERT='INSERT INTO `uniao` (`id`,`encarregado_id`,`crianca_id`,`estado`) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `uniao` (`encarregado_id`,`crianca_id`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `uniao` SET `id`=?,`encarregado_id`=?,`crianca_id`=?,`estado`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `uniao` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `uniao` WHERE `id`=?';
	const FIELD_ID=-309467157;
	const FIELD_ENCARREGADO_ID=471182279;
	const FIELD_CRIANCA_ID=-1250179003;
	const FIELD_ESTADO=493366326;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of Uniao instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param Uniao $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return Uniao[]
	 */
	public static function findByExample(PDO $db,Uniao $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of Uniao instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of Uniao instances
	 *
	...
	/**
	 * returns the result as an array of Uniao instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return Uniao[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of Uniao instances.
	 *
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(4,$this->getEstado());
	}
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'Uniao');
	}

	/**
	 * get single Uniao instance from a DOMElement
	 *
	...
	/**
	 * get all instances of Uniao from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('Uniao') as $node) {
