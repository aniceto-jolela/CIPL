 ...
 * @package entity
 */
class NotificacaoFuncionario extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='NotificacaoFuncionario';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='notificacao_funcionario';
	const SQL_INSERT='INSERT INTO `notificacao_funcionario` (`id`,`funcionario_id`,`descricao`,`data_n`,`estado`) VALUES (?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `notificacao_funcionario` (`funcionario_id`,`descricao`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `notificacao_funcionario` SET `id`=?,`funcionario_id`=?,`descricao`=?,`data_n`=?,`estado`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `notificacao_funcionario` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `notificacao_funcionario` WHERE `id`=?';
	const FIELD_ID=-1857032749;
	const FIELD_FUNCIONARIO_ID=-67088713;
	const FIELD_DESCRICAO=844269201;
	const FIELD_DATA_N=1622310353;
	const FIELD_ESTADO=1667563038;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of NotificacaoFuncionario instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param NotificacaoFuncionario $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return NotificacaoFuncionario[]
	 */
	public static function findByExample(PDO $db,NotificacaoFuncionario $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of NotificacaoFuncionario instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `notificacao_funcionario`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of NotificacaoFuncionario instances
	 *
	...
	/**
	 * returns the result as an array of NotificacaoFuncionario instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return NotificacaoFuncionario[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of NotificacaoFuncionario instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `notificacao_funcionario`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'NotificacaoFuncionario');
	}

	/**
	 * get single NotificacaoFuncionario instance from a DOMElement
	 *
	...
	/**
	 * get all instances of NotificacaoFuncionario from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('NotificacaoFuncionario') as $node) {
