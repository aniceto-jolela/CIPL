<?php	
    ...
    $subsidio = SubsidioFeria::findBySql(con(), "SELECT * FROM `subsidio_feria` ORDER BY data_emissao");
    ...
    $html.="<div id='tabela_top2'>
            ...
            ";
    $html.="<p id='data'>SUBSÍDIO DE FÉRIA REFERENTE AO MÊS DE ".$data." DE ".$ano." </p>";
