...
?>
   <thead>
        <tr>
            ...
            <th data-field="sub">SUBSÍDIO DE<br> 13º MÊS</th>
    ...
    <tbody>
        <?php 
            ...
            $dataSelec = $_GET["data"];
            $subsidio_dM = SubsidioDTerceiroMes::findBySql(con(), "SELECT * FROM subsidio_d_terceiro_mes ORDER BY data_emissao");
            $ver = Cargo::findBySql(con(), "SELECT * FROM cargo ORDER BY nome");
            $id = 0; $saldo = 0;$sb=0;$beneficio=0;
            foreach ($subsidio_dM as $i):
