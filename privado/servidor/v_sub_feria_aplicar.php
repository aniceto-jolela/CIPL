...
?>
    <thead>
        <tr>
            ...
            <th data-field="feria">FÉRIA | TODOS <input type="checkbox" id="sub_feria" onclick="subFeria()" class="lk"></th>
        </tr>
    </thead>
    <tbody >
         <?php 
        ...
        <tr>
            ...
            ?></td>
            <td><input type="checkbox" class="sub_feria_td lk" name="sub_feria[]" value="<?php echo $i->getId() ?>" ></td>
        </tr>
            <?php }}endforeach; ?>
        <tr>
    </tbody>
