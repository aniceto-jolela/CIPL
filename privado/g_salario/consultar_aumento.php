                    ...
                    <div class="row"><br><br>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <ul class="breadcrumb">
                                ...
                                <li><i class="glyphicon glyphicon-refresh"></i><span> Consultar aumento</span>
                                </li>
                                <a href="../servidor/pdf_aumento_s.php" target="_blanck"><i class="fa fa-print pull-right fa-2x"></i></a>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php 
                                                $ver = Aumento::findBySql(con(), "SELECT * FROM aumento ORDER BY data_d ASC");
                                                foreach ($ver as $i):
                                                    $func = Funcionario::findById(con(), $i->getFuncionarioId());
                                                    $slAntigo = $func->getSalarioBase()-$i->getAumento();
                                                    if($func->getEstado()==0){
                                            ?>
                                                <tr>
