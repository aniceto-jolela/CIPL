                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h3 class="page-header cor_sumario">
                                <i class="fa fa-clipboard"></i> Subsídio de férias
                            </h3>
                            <ul class="breadcrumb">
                                <li><i class="fa fa-home"></i> <a href="index.php">Home</a>
                                </li>
                                <li><i class="glyphicon glyphicon-refresh"></i><span> Faz & consulta Subsídio de férias</span>
                                </li>
                            ...
                            <div class="sparkline13-graph">
                                <!-- CONSULTA  -->
                                    <div class="col-lg-2 mg-b-20">
                                        <select name="s_falta" id="add_data" class="informacao" tabindex="-1" onchange="mostrarSubsidioF(this.value)">
                                            <option disabled selected> Consultar data </option>
                                            <?php 
                                                $SF = SubsidioFeria::findBySql(con(), "SELECT * FROM `subsidio_feria` ORDER BY data_emissao");
                                                $dAM = 0;
                                                foreach ($SF as $d):
                                                    $MT = $d->getDataEmissao();
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <form method="post"  id="fomDados">
                                        ...
                                        <?php
                                            ...
                                            $BSF = SubsidioFeria::findBySql(con(), "SELECT * FROM `subsidio_feria` ORDER BY data_emissao");
                                            foreach ($BSF as $bf) {
                                                $data_hoje = date("Y-m");
